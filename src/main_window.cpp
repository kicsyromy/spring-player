...
void MainWindow::set_tile(PlaybackList::PlaybackState state, MainWindow *self) noexcept
{
    LOG_INFO("MainWindow({}): Playback state changed to {}", void_p(self),
    ...
    if (state == PlaybackList::PlaybackState::Playing)
    {
        ...
        self->header_.set_title(
            ...
            HeaderBar::Text::Markup);
    }
    else
    {
        self->header_.set_title("Spring Player", HeaderBar::Text::Plain);
    }
}
